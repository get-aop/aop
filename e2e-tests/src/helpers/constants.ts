...
export const DEFAULT_PID_FILE = join(E2E_TEST_BASE_DIR, "aop.pid");

export const E2E_TEST_HOME_DIR = join(E2E_TEST_BASE_DIR, "home");
...
export const createTestAopHome = (testName: string): TestAopHome => {
  const baseDir = join(E2E_TEST_BASE_DIR, "aop-test-home");

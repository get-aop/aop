...
Implement three related task folders. E2E and benchmark fixtures may still use legacy `docs/tasks/` paths in the fixture repo; production AOP stores canonical task docs under `~/.aop/repos/<repo-id>/tasks/`.

...
import { createLicenseService, type LicenseService } from "./license/service.ts";
import { createLicenseStorage, type LicenseStorage } from "./license/storage.ts";
...
export const createCommandContext = (
  ...
  context = {
    ...
    licenseService: undefined as unknown as LicenseService,
    licenseStorage: undefined as unknown as LicenseStorage,
    taskEventEmitter,
    logBuffer,
    logFlusher,
    linearHandlers,
  ...
  const licenseStorage = createLicenseStorage(settingsRepository);
  context.licenseStorage = licenseStorage;
  context.licenseService = createLicenseService(licenseStorage, agentRepository);

...
export type TaskUpdatedEvent = DashboardTaskUpdatedEvent;
export type TaskRemovedEvent = DashboardTaskRemovedEvent;
export type HeartbeatEvent = DashboardHeartbeatEvent;
export type ChatUnreadEvent = DashboardChatUnreadEvent;
      ...
      switch (eventType) {
        case "init": {
          ...
          return {
            ...
            data: {
              tasks,
              capacity: status.globalCapacity,
        ...
        case "task-status-changed": {
          ...
          return {
            ...
            data: {
              ...
              hasPlan: backendEvent.task.hasPlan,
              swimlane: backendEvent.task.swimlane,
              boardColumn: backendEvent.task.boardColumn,
              runtimeActivity: backendEvent.task.runtimeActivity,
              completionMode: backendEvent.task.completionMode,
              assignedAgentRole: backendEvent.task.assignedAgentRole,
            },
          };
        }
        case "task-updated": {
          const backendEvent = parsed as SSETaskUpdatedEvent;
          return {
            type: "task-updated",
            data: {
              taskId: backendEvent.taskId,
              archivedAt: backendEvent.task.archivedAt ?? null,
              updatedAt: backendEvent.task.updatedAt,
            },
          };
        }
        ...
        case "chat-unread": {
          const backendEvent = parsed as SSEChatUnreadEvent;
          return {
            type: "chat-unread",
            data: {
              sessionId: backendEvent.sessionId,
              title: backendEvent.title,
              snippet: backendEvent.snippet,
              kind: backendEvent.kind,
            },
          };
        }
        case "heartbeat":

...
export function shouldUseCompactComposerFooter(
  ...
  return width !== null && width > 0 && width < breakpoint;
}
...
export function shouldUseCompactComposerPrimaryActions(
  ...
  if (!options?.hasWideActions) return false;
  return width !== null && width > 0 && width < COMPOSER_PRIMARY_ACTIONS_COMPACT_BREAKPOINT_PX;
}

...
The dashboard is Sessions-first: a chat workbench per repository, a composer with runtime/workflow controls, a right panel (Tasks · Checks · Logs · Changes), a terminal dock, and task detail at `/tasks/:id`. Settings covers repositories, runtimes, execution hosts, workflows, license, and about.
